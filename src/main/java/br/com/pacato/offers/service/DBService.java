...
public class DBService {
    ...
    public void instanciaBaseDeDados() {
        ...
        Pedido pedido2 = new Pedido(null, "Oracle Database", BigDecimal.valueOf(3232), LocalDate.now(), "https://www.oracle.com/br/database/", "https://www.oracle.com/a/ocom/img/rc32-data-management.png", "Oracle database é um dos melhores do mercado!", StatusPedido.AGUARDANDO);
